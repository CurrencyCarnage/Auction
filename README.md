...
The live app still defaults to JSON storage. Use `npm run test:postgres` against a staging database before enabling `STORAGE_DRIVER=postgres` on any public deployment.
